...
class BLPInterface:
    ...
    # def __init__(self, host='191.209.42.41', port=8194, open=True):
    ...
    def bdh(self, securities, fields, startDate, endDate, **kwargs):
        ...
        if type(securities) == str:
            ...
            data = pd.concat(data, keys=keys, axis=1, names=['Security', 'Field'], sort=False)
...
def main():
    blp = BLPInterface()
    #ativos = ['LU0252652382', 'LU0068578508', 'IE00B6STVH45', 'LU0912262788', 'LU0912262788', 'LU0502882342', 'IE00B8BPMF80']
    #ativos = ['US71647NAS80 Corp', 'USP07785AE11 Corp', 'USP07785AD38 Corp', 'USG9400PAA24 Corp', 'US71647NAF69 Corp', 'USG0732RAG32 Corp', 'US46556MAK80Corp', 'US46556MAJ18 Corp']
    ativos = ['BCSFLPDV Index', 'BCSFQPDV Index']
    df = blp.bdh(ativos, 'PX_LAST', '20100101', '20180822')
    df.to_csv('DICurtoVSLondi.csv')
